  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate="visible"
        style={{ opacity: fade }}
        className="relative z-10 mx-auto grid w-full max-w-6xl items-center gap-12 px-5 pt-32 pb-20 md:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16"
      >
        ...
        <div className="order-2 flex flex-col items-center text-center lg:order-1 lg:items-start lg:text-left">
          ...
          <motion.h1
            variants={item}
            className="mt-7 font-display text-5xl sm:text-6xl md:text-7xl font-semibold leading-[1.05] text-mist-50"
          >
            {hero.greeting}
          </motion.h1>
          ...
          <motion.p
            variants={item}
            className="mt-3 bg-gradient-to-r from-gold-200 via-gold-400 to-gold-500 bg-clip-text font-serif-alt text-3xl md:text-4xl italic font-light text-transparent"
          >
            {hero.name}
          </motion.p>

          <motion.div variants={item} className="mt-7 flex items-center gap-4" aria-hidden="true">
            <span className="h-px w-12 bg-gold-500/50" />
            <span className="h-1.5 w-1.5 rotate-45 bg-gold-400" />
            <span className="h-px w-12 bg-gold-500/50" />
          </motion.div>

          <motion.p variants={item} className="mt-7 max-w-md font-serif-alt text-lg md:text-xl italic text-mist-300/90 leading-relaxed">
      ...
      <motion.div
        ...
        style={{ opacity: fade }}
        className="absolute bottom-7 inset-x-0 z-10 flex justify-center"
      >
        <motion.div
          animate={{ y: [0, 7, 0] }}
